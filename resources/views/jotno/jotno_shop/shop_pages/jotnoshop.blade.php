                        ...
                        <ul>
                            <li data-transition='slotzoom-horizontal' data-slotamount='7' data-masterspeed='1000' data-thumb='{{asset('public/jotno_shop/assets/images/slider/slide-img1.jpg')}}'><img src='{{asset('public/jotno_shop/assets/images/slider/slide-img1.jpg')}}' alt="slider image1" data-bgposition='left top'  data-bgfit='cover' data-bgrepeat='no-repeat'  />
                                <div class="info">
                                    ...
                                    <div class='tp-caption sfb  tp-resizeme ' data-x='0'  data-y='350'  data-endspeed='500'  data-speed='500' data-start='1500' data-easing='Linear.easeNone' data-splitin='none' data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1' style='z-index:4;white-space:nowrap;'><a style="background-color: #1cb410; border-color: #1cb410" href='#' class="buy-btn">Browse Now</a></div>
                                </div>
                            </li>
                            <li data-transition='slotzoom-horizontal' data-slotamount='7' data-masterspeed='1000' data-thumb='{{asset('public/jotno_shop/assets/images/slider/slide-img3.jpg')}}'><img src='{{asset('public/jotno_shop/assets/images/slider/slide-img3.jpg')}}' alt="slider image2" data-bgposition='left top'  data-bgfit='cover' data-bgrepeat='no-repeat'  />
                                <div class="info">
                                    ...
                                    <div    class='tp-caption sfb  tp-resizeme ' data-x='45'  data-y='350'  data-endspeed='500'  data-speed='500' data-start='1500' data-easing='Linear.easeNone' data-splitin='none' data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1' style='z-index:4;white-space:nowrap;'><a style="background-color: #1cb410; border-color: #1cb410" href='#' class="buy-btn">Join us</a></div>
                                </div>
                            </li>
                            <li data-transition='slotzoom-horizontal' data-slotamount='7' data-masterspeed='1000' data-thumb='{{asset('public/jotno_shop/assets/images/slider/slide-img2.jpg')}}'><img src='{{asset('public/jotno_shop/assets/images/slider/slide-img2.jpg')}}' alt="slider image3" data-bgposition='left top'  data-bgfit='cover' data-bgrepeat='no-repeat'  />
                                <div class="info">
                                    ...
                                    <div    class='tp-caption sfb  tp-resizeme ' data-x='45'  data-y='350'  data-endspeed='500'  data-speed='500' data-start='1500' data-easing='Linear.easeNone' data-splitin='none' data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1' style='z-index:4;white-space:nowrap;'><a style="background-color: #1cb410; border-color: #1cb410" href='#' class="buy-btn">Buy Now</a></div>
                                </div>
                            </li>
                        </ul>
                    </div>
        ...
        <div style="background-color: #2b542c; border-color: #2b542c" class="support-policy-box">
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="support-policy"> <i style="color: #1cb410" class="fa fa-truck"></i>
                        <div style="color: white" class="content">Free Shipping on order over $49</div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="support-policy"> <i style="color: #1cb410" class="fa fa-phone"></i>
                        <div style="color: white" class="content">Need Help +1 123 456 7890</div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="support-policy"> <i style="color: #1cb410" class="fa fa-refresh"></i>
                        <div style="color: white" class="content">30 days return Service</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <!-- Trending Products Slider -->
                    <div style="background-color: #2b542c; border: #2b542c" class="jtv-trending-products">
                        <div class="slider-items-products">
                            <div style="border-color: #1cb410" class="jtv-new-title">
                                <h2 style="color: white">Trending Products</h2>
                            </div>
                                            ...
                                            <div class="item-info">
                                                <div class="info-inner">
                                                    ...
                                                    <div class="item-content">
                                                        ...
                                                        <div class="item-price">
                                                            <div class="price-box"> <span class="regular-price"> <span style="color: white" class="price">$222.79</span></span>
