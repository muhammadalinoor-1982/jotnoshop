                    ...
                    <div class="col-lg-12 col-12 mb-20">
                        <div class="row mbn-15">
                            <div class="col-12 mb-15">
                                <img src="{{(@$editData->image)?url('public/jotno_admin/assets/images/brand_logo/'.@$editData->image):url('public/jotno_admin/assets/images/brand_logo/noimage.jpg')}}"  alt="" class="product-image rounded-circle">
