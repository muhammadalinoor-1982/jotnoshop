                        ...
                        <ul class="header-notification-area">
                            ...
                            <li class="adomx-dropdown position-relative col-auto">
                                ...
                                <ul class="adomx-dropdown-menu dropdown-menu-language">
                                    <li><a href="#"><img src="{{asset('public/jotno_admin/assets/images/flags/flag-1.jpg')}}" alt=""> English</a></li>
                                    <li><a href="#"><img src="{{asset('public/jotno_admin/assets/images/flags/flag-2.jpg')}}" alt=""> Japanese</a></li>
                                    <li><a href="#"><img src="{{asset('public/jotno_admin/assets/images/flags/flag-3.jpg')}}" alt=""> Spanish </a></li>
                                ...
                                <div class="adomx-dropdown-menu dropdown-menu-mail">
                                    ...
                                    <div class="body custom-scroll">
                                        <ul>
                                            <li>
                                                <a href="#">
                                                    <div class="image"><img src="{{asset('public/jotno_admin/assets/images/avatar/avatar-2.jpg')}}" alt=""></div>
                                                    <div class="content">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <div class="image"><img src="{{asset('public/jotno_admin/assets/images/avatar/avatar-1.jpg')}}" alt=""></div>
                                                    <div class="content">
