        ...
        <div class="row justify-content-between align-items-center mb-10">
            ...
            <div class="col-12 col-lg-auto mb-20">
                <div class="page-heading">
                    <h3><a title="Back to Mail Menu" class="edit button button-box button-xs button-info" href="{{ route('Register.customer.view')}}"><i class="zmdi zmdi-mail-reply-all"></i></a> &nbsp; Customer Details Page</h3>
                </div>
                        ...
                        <div class="col-12 mb-50">
                            <ul class="timeline-list">
                                <li>
                                    ...
                                    <div class="details">
                                        <h5 class="title"><a href="{{ route('Register.customer.view')}}">{{$editData->name}}</a></h5>
                                        <div class="gallery">
                                ...
                                <li>
                                    <span class="icon"><i class="zmdi zmdi-receipt"></i></span>
                                    <div class="details">
                                        <h5 class="title"><a href="{{ route('Register.customer.view')}}">{{$editData->name}} Details</a></h5>
                                        <div class="content">
