                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-center">
                                    <div class="row">
                                        ...
                                        <a title="Related Image Edit" class="edit button button-box button-xs button-warning" href="{{ route('product.related_img.edit',$product->id) }}"><i class="zmdi zmdi-image"></i></a>
