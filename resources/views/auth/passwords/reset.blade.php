        ...
        <div class="main container">
            <div style="background-color: #00320f; border-color: #00320f; color: white" class="account-login">
                <div class="page-title">
                    ...
                    <h2 style="position: relative; right: -440px; color: white">New Password</h2>
                </div>
                <br>
                    ...
                    <div class="col-2 registered-users">
                        <div class="content">
                            ...
                            <div class="buttons-set">
                                <button style="position: relative; right: -520px; background-color: #00ff12; border-color: #00ff12" id="send2" name="submit" type="submit" class="button login"><span>Reset Password</span></button>
                            </div><br>
                        </div>
                    </div>
                </form>
