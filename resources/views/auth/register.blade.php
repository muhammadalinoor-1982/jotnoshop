    ...
    <section style="background-color: darkgreen" class="main-container col1-layout">
        <div class="main container">
            <div style="background-color: #00320f; border-color: #00320f; color: white" class="account-login">
                ...
                <br>
                <form method="POST" action="{{ route('jotno.register') }}">
                @csrf
                <div class="col-2 registered-users">
                    <div class="content">
                        <ul class="form-list">
                            <li>
                                <label for="name">Email Address <span style="color: yellow" class="required">*</span></label>
                                <input style="background-color: rgba(23,105,0,0.92); border-color: rgba(23,105,0,0.92)" type="text" title="Name" class="input-text required-entry @error('name') is-invalid @enderror" id="name" value="{{ old('name') }}" name="name" required autocomplete="name" autofocus>
                                @error('name')
                            ...
                            <li>
                                ...
                                <input style="background-color: rgba(23,105,0,0.92); border-color: rgba(23,105,0,0.92)" type="text" title="Mobile Number" id="mobile @error('mobile') is-invalid @enderror" class="input-text required-entry" name="mobile" value="{{ old('mobile') }}" required autocomplete="mobile" autofocus>
                                @error('mobile')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <li>
                                ...
                                <input style="background-color: rgba(23,105,0,0.92); border-color: rgba(23,105,0,0.92)" type="password" title="Password" id="password" class="input-text required-entry @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                                @error('password')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <li>
                                ...
                                <input style="background-color: rgba(23,105,0,0.92); border-color: rgba(23,105,0,0.92)" type="password" title="Confirm Password" id="password-confirm" class="input-text required-entry" name="password_confirmation">
                            </li>
                        </ul>
